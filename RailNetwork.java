...
public class RailNetwork {
    ...
    RailNetwork(String stationsMapString) {
    ...
    //Ex: A-E-B-C-D
    private void printRouteDistance(String route) {
    ...
    private int numberOfRoutes(String source, String destination, int threshold, DistanceMetric distanceMetric, DistanceComparator distanceComparator) {
    ...
    private int lengthOfShortestRoute(String source, String destination) {
        Stack<StationToVisit> stationsToVisit = new Stack<>();
